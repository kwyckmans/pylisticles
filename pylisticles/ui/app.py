    ...
    def refresh_collections(self) -> None:
        ...
        try:
            ...
            if not self.collections:
                list_view.append(ListItem(Static("No collections found"), disabled=True))
            else:
...
class CollectionDetailView(Container):
    ...
    def _update_display(self) -> None:
        ...
        if not self.current_collection.items:
            table.add_row(*["No items" if i == 0 else "" for i in range(len(field_names))])
        else:
...
class PylisticlesApp(App[None]):
    ...
    def _update_view(self) -> None:
        ...
        if self.current_view == "list":
            ...
            collection_name = getattr(self.collection_detail.current_collection, 'name', 'Collection')
    ...
    def action_refresh(self) -> None:
        ...
        elif self.current_view == "detail" and self.collection_detail.current_collection:
            self.collection_detail.show_collection(self.collection_detail.current_collection.name)
